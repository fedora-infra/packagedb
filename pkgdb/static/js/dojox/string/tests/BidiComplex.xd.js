...
return {depends: [["provide", "dojox.string.tests.BidiComplex"],
["require", "dojox.string.BidiComplex"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.string.tests.BidiComplex"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
