...
return {depends: [["provide", "dojox.lang.tests.recomb"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.lang.tests.recomb"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
