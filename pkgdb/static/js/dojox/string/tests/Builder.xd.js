...
return {depends: [["provide", "dojox.string.tests.Builder"],
["require", "dojox.string.Builder"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.string.tests.Builder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
