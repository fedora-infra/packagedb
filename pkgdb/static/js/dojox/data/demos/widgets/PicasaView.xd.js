...
return {depends: [["provide", "dojox.data.demos.widgets.PicasaView"],
["require", "dijit._Templated"],
["require", "dijit._Widget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.demos.widgets.PicasaView"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
