...
return {depends: [["provide", "dojox.json.tests.schema"],
["require", "dojox.json.schema"],
["require", "dojox.json.ref"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.tests.schema"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
