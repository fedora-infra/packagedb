...
return {depends: [["provide", "tests.string"],
["require", "dojo.string"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.string"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
