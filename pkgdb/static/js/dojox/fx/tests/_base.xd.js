...
return {depends: [["provide", "dojox.fx.tests._base"],
["require", "dojox.fx._core"],
["require", "dojox.fx"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.fx.tests._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
