...
return {depends: [["provide", "dojox.wire.demos.WidgetRepeater"],
["require", "dojo.parser"],
["require", "dijit._Widget"],
["require", "dijit._Templated"],
["require", "dijit._Container"],
["require", this.widget]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.demos.WidgetRepeater"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
