...
return {depends: [["provide", "dojox.data.tests.dom"],
["require", "dojox.data.dom"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.dom"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
