...
return {depends: [["provide", "dojox.rpc.tests.Yahoo"],
["require", "dojo.io.script"],
["require", "dojox.rpc.Service"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.rpc.tests.Yahoo"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
