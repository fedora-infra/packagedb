...
return {depends: [["provide", "dojox.wire.tests.programmatic.DataWire"],
["require", "dojox.wire.DataWire"],
["require", "dojox.data.XmlStore"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.DataWire"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
