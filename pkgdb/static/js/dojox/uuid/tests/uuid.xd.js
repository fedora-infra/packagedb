...
return {depends: [["provide", "dojox.uuid.tests.uuid"],
["require", "dojox.uuid"],
["require", "dojox.uuid.Uuid"],
["require", "dojox.uuid.generateRandomUuid"],
["require", "dojox.uuid.generateTimeBasedUuid"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.uuid.tests.uuid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
