...
return {depends: [["provide", "dojox.wire.tests.programmatic.XmlWire"],
["require", "dojox.wire.XmlWire"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.XmlWire"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
