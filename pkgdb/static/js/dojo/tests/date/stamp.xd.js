...
return {depends: [["provide", "tests.date.stamp"],
["require", "dojo.date.stamp"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.date.stamp"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
