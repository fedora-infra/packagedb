...
return {depends: [["provide", "dojox.jsonPath.tests.jsonPath"],
["require", "dojox.jsonPath"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.jsonPath.tests.jsonPath"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
