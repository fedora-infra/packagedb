...
return {depends: [["provide", "dojo.tests.manualTests"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.tests.manualTests"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
