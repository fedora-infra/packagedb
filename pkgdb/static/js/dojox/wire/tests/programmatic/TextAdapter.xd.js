...
return {depends: [["provide", "dojox.wire.tests.programmatic.TextAdapter"],
["require", "dojox.wire.TextAdapter"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.TextAdapter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
