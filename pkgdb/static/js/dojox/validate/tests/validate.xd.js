...
return {depends: [["provide", "dojox.validate.tests.validate"],
["require", "dojox.validate._base"],
["require", "dojox.validate.check"],
["require", "dojox.validate.us"],
["require", "dojox.validate.ca"],
["require", "dojox.validate.web"],
["require", "dojox.validate.isbn"],
["requireLocalization", "dojo.cldr", "currency", localeList[i], "ja,fr,pt,ko,en,zh,de,ROOT,zh-tw,en-ca,en-au,it,es,en-us", "ja,fr,pt,ko,en,zh,de,ROOT,zh-tw,en-ca,en-au,it,es,en-us"],
["requireLocalization", "dojo.cldr", "number", localeList[i], "ja,fr,pt,zh-cn,ko,de-de,en,zh,ja-jp,de,en-gb,zh-tw,en-au,ROOT,it,es-es,es,ko-kr,en-us", "ja,fr,pt,zh-cn,ko,de-de,en,zh,ja-jp,de,en-gb,zh-tw,en-au,ROOT,it,es-es,es,ko-kr,en-us"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.validate.tests.validate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
