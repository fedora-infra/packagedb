...
return {depends: [["provide", "dojox.data.tests.stores.FlickrRestStore"],
["require", "dojox.data.FlickrRestStore"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.FlickrRestStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
