...
return {depends: [["provide", "dojox.data.tests.stores.JsonRestStore"],
["require", "dojox.data.JsonRestStore"],
["require", "dojo.data.api.Read"],
["require", "dojox.rpc.Service"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.JsonRestStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
