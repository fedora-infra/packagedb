...
return {depends: [["provide", "dojox.encoding.tests.compression.lzw"],
["require", "dojox.encoding.compression.lzw"],
["require", "dojox.encoding.bits"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.tests.compression.lzw"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
