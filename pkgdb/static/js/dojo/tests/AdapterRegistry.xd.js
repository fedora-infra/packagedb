...
return {depends: [["provide", "tests.AdapterRegistry"],
["require", "dojo.AdapterRegistry"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.AdapterRegistry"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
