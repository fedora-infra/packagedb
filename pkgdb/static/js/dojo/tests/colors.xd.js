...
return {depends: [["provide", "tests.colors"],
["require", "dojo.colors"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.colors"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
