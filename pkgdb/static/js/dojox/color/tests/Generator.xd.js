...
return {depends: [["provide", "dojox.color.tests.Generator"],
["require", "dojox.color.Generator"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.tests.Generator"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
