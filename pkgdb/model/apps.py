...
ApplicationsTable = Table('applications', metadata, 
    ...
    Column('iconnameid', Integer, nullable=True),
    Column('iconid', Integer, nullable=True),
    Column('summary', Text, nullable=True),
    Column('icon_status_id', Integer, PassiveDefault(text(str(MS_NEW))), nullable=False),
...
IconsTable = Table('icons', metadata,
    Column('id', Integer, autoincrement=True, primary_key=True),
    Column('nameid', Integer, nullable=False),
    Column('collectionid', Integer, nullable=False),                   
    Column('themeid', Integer, nullable=False),
    Column('icon', Binary, nullable=False),
    Column('orig_size', Integer, nullable=False, server_default=text('48')),
    Column('m_status_id', Integer, nullable=False, server_default=text(str(MS_NEW))),
