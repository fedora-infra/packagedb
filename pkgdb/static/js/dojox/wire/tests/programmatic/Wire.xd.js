...
return {depends: [["provide", "dojox.wire.tests.programmatic.Wire"],
["require", "dojox.wire.Wire"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.Wire"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
