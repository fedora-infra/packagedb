...
return {depends: [["provide", "dojox.json.tests.query"],
["require", "dojox.json.query"],
["require", "dojox.jsonPath"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.tests.query"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
