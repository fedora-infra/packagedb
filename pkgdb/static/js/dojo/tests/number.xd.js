...
return {depends: [["provide", "tests.number"],
["require", "dojo.number"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.number"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
