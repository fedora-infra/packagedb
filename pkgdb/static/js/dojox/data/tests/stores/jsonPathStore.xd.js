...
return {depends: [["provide", "dojox.data.tests.stores.jsonPathStore"],
["require", "dojox.data.jsonPathStore"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.jsonPathStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
