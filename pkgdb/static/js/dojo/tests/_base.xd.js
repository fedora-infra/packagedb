...
return {depends: [["provide", "tests._base"],
["require", "tests._base._loader.bootstrap"],
["require", "tests._base._loader.loader"],
["platformRequire", {
...
["require", "tests._base.array"],
["require", "tests._base.Color"],
["require", "tests._base.lang"],
["require", "tests._base.declare"],
["require", "tests._base.connect"],
["require", "tests._base.Deferred"],
["require", "tests._base.json"],
["requireIf", dojo.isBrowser, "tests._base.html"],
["requireIf", dojo.isBrowser, "tests._base.fx"],
["requireIf", dojo.isBrowser, "tests._base.query"],
["requireIf", dojo.isBrowser, "tests._base.xhr"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
