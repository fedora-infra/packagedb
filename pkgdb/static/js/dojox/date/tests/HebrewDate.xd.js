...
return {depends: [["provide", "dojox.date.tests.HebrewDate"],
["require", "dojox.date.HebrewDate"],
["require", "dojo.date"],
["requireLocalization", "dojo.cldr", "hebrew", locale, "", ""]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.tests.HebrewDate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
