...
return {depends: [["provide", 'dojox.grid.compat._data.model'],
["require", 'dojox.grid.compat._data.fields']],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource['dojox.grid.compat._data.model']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
