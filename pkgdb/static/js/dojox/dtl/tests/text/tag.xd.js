...
return {depends: [["provide", "dojox.dtl.tests.text.tag"],
["require", "dojox.dtl"],
["require", "dojox.dtl.Context"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.dtl.tests.text.tag"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
