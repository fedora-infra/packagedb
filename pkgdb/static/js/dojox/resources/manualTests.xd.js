...
return {depends: [["provide", "dojox.tests.manualTests"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.tests.manualTests"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
