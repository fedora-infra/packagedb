...
return {depends: [["provide", "dojox.color.tests._base"],
["require", "dojox.color"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.tests._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
