...
return {depends: [["provide", "dojox.encoding.tests.crypto.Blowfish"],
["require", "dojox.encoding.crypto.Blowfish"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.tests.crypto.Blowfish"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
