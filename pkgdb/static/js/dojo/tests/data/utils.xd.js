...
return {depends: [["provide", "tests.data.utils"],
["require", "dojo.data.util.filter"],
["require", "dojo.data.util.sorter"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.data.utils"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
