...
return {depends: [["provide", "dojox.grid.tests.databaseModel"],
["require", "dojox.grid._data.model"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.tests.databaseModel"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
