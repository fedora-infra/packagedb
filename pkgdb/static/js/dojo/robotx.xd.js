...
return {depends: [["provide", "dojo.robotx"],
["require", "dojo.robot"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.robotx"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
