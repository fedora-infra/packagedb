...
return {depends: [["provide", "dojox.data.tests.stores.ServiceStore"],
["require", "dojox.rpc.Service"],
["require", "dojox.rpc.Rest"],
["require", "dojox.data.ServiceStore"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.ServiceStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
