...
return {depends: [["provide", "dojox.wire.tests.programmatic.TableAdapter"],
["require", "dojox.wire.TableAdapter"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.TableAdapter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
