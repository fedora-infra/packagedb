...
return {depends: [["provide", "dojox.date.HebrewDate"],
["require", "dojo.date.locale"],
["requireLocalization", "dojo.cldr", "hebrew", null, "", ""]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.HebrewDate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
