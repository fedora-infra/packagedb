...
return {depends: [["provide", "dojox.grid.compat._grid.layout"],
["require", "dojox.grid.compat._grid.cell"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._grid.layout"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
