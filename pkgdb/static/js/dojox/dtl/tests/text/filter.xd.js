...
return {depends: [["provide", "dojox.dtl.tests.text.filter"],
["require", "dojox.dtl"],
["require", "dojox.dtl.Context"],
["require", "dojox.dtl.utils.date"],
["require", "dojox.date.php"],
["require", "dojox.string.sprintf"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.dtl.tests.text.filter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
