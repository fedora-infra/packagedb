...
return {depends: [["provide", "dojox.grid.compat._grid.view"],
["require", "dijit._Widget"],
["require", "dijit._Templated"],
["require", "dojox.grid.compat._grid.builder"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._grid.view"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
