...
return {depends: [["provide", "dojox.data.demos.widgets.FileView"],
["require", "dijit._Templated"],
["require", "dijit._Widget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.demos.widgets.FileView"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
