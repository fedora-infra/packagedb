...
return {depends: [["provide", "dojox.data.tests.stores.CsvStore"],
["require", "dojox.data.CsvStore"],
["require", "dojo.data.api.Read"],
["require", "dojo.data.api.Identity"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.CsvStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
