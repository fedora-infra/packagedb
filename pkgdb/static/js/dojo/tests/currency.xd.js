...
return {depends: [["provide", "tests.currency"],
["require", "dojo.currency"],
["requireLocalization", "dojo.cldr","currency",partLocaleList[i], "ja,fr,pt,ko,en,zh,de,ROOT,zh-tw,en-ca,en-au,it,es,en-us", "ja,fr,pt,ko,en,zh,de,ROOT,zh-tw,en-ca,en-au,it,es,en-us"],
["requireLocalization", "dojo.cldr","number",partLocaleList[i], "ja,fr,pt,zh-cn,ko,de-de,en,zh,ja-jp,de,en-gb,zh-tw,en-au,ROOT,it,es-es,es,ko-kr,en-us", "ja,fr,pt,zh-cn,ko,de-de,en,zh,ja-jp,de,en-gb,zh-tw,en-au,ROOT,it,es-es,es,ko-kr,en-us"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.currency"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
