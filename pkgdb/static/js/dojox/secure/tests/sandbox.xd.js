...
return {depends: [["provide", "dojox.secure.tests.secure"],
["require", "dojox.secure.secure"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.secure.tests.secure"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
