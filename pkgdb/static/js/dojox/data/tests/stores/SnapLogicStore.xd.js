...
return {depends: [["provide", "dojox.data.tests.stores.SnapLogicStore"],
["require", "dojox.data.SnapLogicStore"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.SnapLogicStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
