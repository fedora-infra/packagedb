...
return {depends: [["provide", "dojox.grid.compat._grid.focus"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._grid.focus"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
