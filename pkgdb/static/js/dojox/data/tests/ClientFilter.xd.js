...
return {depends: [["provide", "dojox.data.tests.ClientFilter"],
["require", "dojox.data.ClientFilter"],
["require", "dojox.data.JsonRestStore"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.ClientFilter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
