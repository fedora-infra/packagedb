...
return {depends: [["provide", "dojox.date.IslamicDate"],
["require", "dojo.date.locale"],
["require", "dojo.date"],
["requireLocalization", "dojo.cldr", "islamic", null, "", ""]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.IslamicDate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
