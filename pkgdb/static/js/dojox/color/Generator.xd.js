...
return {depends: [["provide", "dojox.color.Generator"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.Generator"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
