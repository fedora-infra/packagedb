...
return {depends: [["provide", "dojox.data.tests.stores.XmlStore"],
["require", "dojox.data.XmlStore"],
["require", "dojo.data.api.Read"],
["require", "dojo.data.api.Write"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.XmlStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
