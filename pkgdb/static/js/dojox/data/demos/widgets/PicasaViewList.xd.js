...
return {depends: [["provide", "dojox.data.demos.widgets.PicasaViewList"],
["require", "dijit._Templated"],
["require", "dijit._Widget"],
["require", "dojox.data.demos.widgets.PicasaView"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.demos.widgets.PicasaViewList"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
