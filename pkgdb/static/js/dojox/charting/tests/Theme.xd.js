...
return {depends: [["provide", "dojox.charting.tests.Theme"],
["require", "dojox.charting.Theme"],
["require", "dojox.charting.themes.PlotKit.blue"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.charting.tests.Theme"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
