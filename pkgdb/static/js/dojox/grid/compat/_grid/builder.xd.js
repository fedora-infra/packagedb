...
return {depends: [["provide", "dojox.grid.compat._grid.builder"],
["require", "dojox.grid.compat._grid.drag"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._grid.builder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
