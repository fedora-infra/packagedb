	...
	[{
		...
		setUp: function(){
			...
			for(var i = 0 ; i < localeList.length; i ++){
				dojo.requireLocalization("dojo.cldr", "currency", localeList[i], "ja,fr,pt,ko,en,zh,de,ROOT,zh-tw,en-ca,en-au,it,es,en-us");
				dojo.requireLocalization("dojo.cldr", "number", localeList[i], "ja,fr,pt,zh-cn,ko,de-de,en,zh,ja-jp,de,en-gb,zh-tw,en-au,ROOT,it,es-es,es,ko-kr,en-us");
			}
		},
