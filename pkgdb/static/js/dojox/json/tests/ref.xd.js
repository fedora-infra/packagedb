...
return {depends: [["provide", "dojox.json.tests.ref"],
["require", "dojox.json.ref"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.tests.ref"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
