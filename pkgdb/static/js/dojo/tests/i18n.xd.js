...
return {depends: [["provide", "tests.i18n"],
["require", "dojo.i18n"],
["requireLocalization", "tests","salutations",locale, "", ""]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.i18n"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
