...
return {depends: [["provide", "dojox.grid.compat.tests.databaseModel"],
["require", "dojox.grid.compat._data.model"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat.tests.databaseModel"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
