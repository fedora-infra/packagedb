...
return {depends: [["provide", 'dojox.grid.compat._grid.scroller']],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource['dojox.grid.compat._grid.scroller']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
