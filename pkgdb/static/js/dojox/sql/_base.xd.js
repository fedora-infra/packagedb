...
return {depends: [["provide", "dojox.sql._base"],
["require", "dojox.sql._crypto"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.sql._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
