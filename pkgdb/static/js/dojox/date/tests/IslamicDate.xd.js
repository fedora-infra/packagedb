...
return {depends: [["provide", "dojox.date.tests.IslamicDate"],
["require", "dojox.date.IslamicDate"],
["require", "dojo.date"],
["requireLocalization", "dojo.cldr", "islamic", locale, "", ""]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.tests.IslamicDate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
