...
return {depends: [["provide", "tests._base.json"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests._base.json"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
