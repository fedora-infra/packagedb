...
return {depends: [["provide", "tests.data.ItemFileWriteStore"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.data.ItemFileWriteStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
