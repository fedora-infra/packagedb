...
return {depends: [["provide", "dojox.wire.tests.programmatic._base"],
["require", "dojox.wire._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
