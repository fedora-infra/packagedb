...
return {depends: [["provide", "dojox.wire.tests.programmatic.TreeAdapter"],
["require", "dojox.wire.TreeAdapter"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.tests.programmatic.TreeAdapter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
