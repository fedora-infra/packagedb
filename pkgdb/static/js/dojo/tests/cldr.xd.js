...
return {depends: [["provide", "tests.cldr"],
["require", "dojo.cldr.supplemental"],
["require", "dojo.cldr.monetary"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.cldr"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
