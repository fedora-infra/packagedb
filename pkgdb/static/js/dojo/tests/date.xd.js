...
return {depends: [["provide", "tests.date"],
["require", "dojo.date"],
["require", "tests.date.locale"],
["require", "tests.date.stamp"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.date"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
