...
return {depends: [["provide", "tests.rpc"],
["require", "dojo.rpc.RpcService"],
["require", "dojo.rpc.JsonService"],
["require", "dojo.rpc.JsonpService"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.rpc"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
