...
return {depends: [["provide", "dojox.grid.compat._data.editors"],
["provide", "dojox.grid.compat.editors"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._data.editors"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
