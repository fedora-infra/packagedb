...
return {depends: [["provide", "dojox.gfx.tests.matrix"],
["require", "dojox.gfx.matrix"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.gfx.tests.matrix"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
