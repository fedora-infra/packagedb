...
return {depends: [["provide", "dojox.data.tests.stores.GoogleFeedStore"],
["require", "dojox.data.GoogleFeedStore"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.GoogleFeedStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
