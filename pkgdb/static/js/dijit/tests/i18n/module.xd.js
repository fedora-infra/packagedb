...
return {depends: [["provide", "dijit.tests.i18n.module"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tests.i18n.module"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
