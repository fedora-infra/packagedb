...
return {depends: [["provide", "dojox.highlight.tests.highlight"],
["require", "dojox.highlight"],
["require", "dojox.highlight.languages._all"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.highlight.tests.highlight"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
