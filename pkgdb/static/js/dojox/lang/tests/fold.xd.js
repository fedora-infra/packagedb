...
return {depends: [["provide", "dojox.lang.tests.fold"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.lang.tests.fold"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
