...
return {depends: [["provide", "dojox.encoding.tests.bits"],
["require", "dojox.encoding.bits"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.tests.bits"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
