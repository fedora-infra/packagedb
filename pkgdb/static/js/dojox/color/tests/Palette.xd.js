...
return {depends: [["provide", "dojox.color.tests.Palette"],
["require", "dojox.color.Palette"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.tests.Palette"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
