...
return {depends: [["provide", "dojox.secure.tests.DOM"],
["require", "dojox.secure.DOM"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.secure.tests.DOM"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
