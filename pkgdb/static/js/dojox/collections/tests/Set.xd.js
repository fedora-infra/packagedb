...
return {depends: [["provide", "dojox.collections.tests.Set"],
["require", "dojox.collections.Set"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.collections.tests.Set"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
