...
return {depends: [["provide", "dojox.gfx.tests.decompose"],
["require", "dojox.gfx.decompose"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.gfx.tests.decompose"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
