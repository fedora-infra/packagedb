...
return {depends: [["provide", "dojox.grid.compat._data.dijitEditors"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._data.dijitEditors"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
