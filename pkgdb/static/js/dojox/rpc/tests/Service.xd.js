...
return {depends: [["provide", "dojox.rpc.tests.Service"],
["require", "dojo.io.script"],
["require", "dojox.rpc.Service"],
["require", "dojox.rpc.JsonRPC"],
["require", "dojox.rpc.Rest"],
["require", "dojox.rpc.Client"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.rpc.tests.Service"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
