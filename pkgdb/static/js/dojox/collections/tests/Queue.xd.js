...
return {depends: [["provide", "dojox.collections.tests.Queue"],
["require", "dojox.collections.Queue"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.collections.tests.Queue"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
