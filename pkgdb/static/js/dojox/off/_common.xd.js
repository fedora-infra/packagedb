...
return {depends: [["provide", "dojox.off._common"],
["require", "dojo.gears"],
["require", "dojox.storage"],
["require", "dojox.sql"],
["require", "dojox.off.sync"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.off._common"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
