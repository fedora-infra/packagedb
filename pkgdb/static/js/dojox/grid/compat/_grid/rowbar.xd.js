...
return {depends: [["provide", "dojox.grid.compat._grid.rowbar"],
["require", "dojox.grid.compat._grid.view"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat._grid.rowbar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
