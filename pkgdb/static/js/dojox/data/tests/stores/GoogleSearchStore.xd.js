...
return {depends: [["provide", "dojox.data.tests.stores.GoogleSearchStore"],
["require", "dojox.data.GoogleSearchStore"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.GoogleSearchStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
