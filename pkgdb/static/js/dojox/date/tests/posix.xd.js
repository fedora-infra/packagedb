...
return {depends: [["provide", "dojox.date.tests.posix"],
["require", "dojox.date.posix"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.tests.posix"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
