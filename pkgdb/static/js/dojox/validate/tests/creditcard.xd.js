...
return {depends: [["provide", "dojox.validate.tests.creditcard"],
["require", "dojox.validate.creditCard"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.validate.tests.creditcard"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
