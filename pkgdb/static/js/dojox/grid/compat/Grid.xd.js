...
return {depends: [["provide", "dojox.grid.compat.Grid"],
["require", "dojox.grid.compat.VirtualGrid"],
["require", "dojox.grid.compat._data.model"],
["require", "dojox.grid.compat._data.editors"],
["require", "dojox.grid.compat._data.dijitEditors"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.compat.Grid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
