...
return {depends: [["provide", "tests.DeferredList"],
["require", "dojo.DeferredList"],
["provide", "tests.DeferredList"],
["require", "dojo.DeferredList"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.DeferredList"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
