...
return {depends: [["provide", "dojox.string.tests.sprintf"],
["require", "dojox.string.sprintf"],
["require", "dojo.string"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.string.tests.sprintf"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
