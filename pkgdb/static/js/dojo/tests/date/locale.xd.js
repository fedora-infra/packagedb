...
return {depends: [["provide", "tests.date.locale"],
["require", "dojo.date.locale"],
["requireLocalization", "dojo.cldr", "gregorian", locale, "ja,fr,pt,it-it,zh-cn,ko,en,pt-br,zh,de,en-gb,zh-tw,en-ca,en-au,it,es-es,es,ROOT,ko-kr", "ja,fr,pt,it-it,zh-cn,ko,en,pt-br,zh,de,en-gb,zh-tw,en-ca,en-au,it,es-es,es,ROOT,ko-kr"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["tests.date.locale"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
