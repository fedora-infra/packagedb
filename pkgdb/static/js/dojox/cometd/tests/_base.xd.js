...
return {depends: [["provide", "dojox.cometd.tests._base"],
["require", "dojox.cometd"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.cometd.tests._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
