...
return {depends: [["provide", "dojox.robot.recorder"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.robot.recorder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
