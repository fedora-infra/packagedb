...
return {depends: [["provide", "dojo.robot"],
["require", "doh.robot"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.robot"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
