...
return {depends: [["provide", "dojox.data.demos.stores.LazyLoadJSIStore"],
["require", "dojo.data.ItemFileReadStore"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.demos.stores.LazyLoadJSIStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
