...
return {depends: [["provide", "dojox.data.jsonPathStore"],
["require", "dojox.jsonPath"],
["require", "dojo.date"],
["require", "dojo.date.locale"],
["require", "dojo.date.stamp"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.jsonPathStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
