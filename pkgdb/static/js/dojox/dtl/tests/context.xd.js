...
return {depends: [["provide", "dojox.dtl.tests.context"],
["require", "dojox.dtl"],
["require", "dojox.dtl.Context"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.dtl.tests.context"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
