...
return {depends: [["provide", "dojox.data.tests.stores.AndOrReadStore"],
["require", "dojox.data.AndOrReadStore"],
["require", "dojo.data.api.Read"],
["require", "dojo.data.api.Identity"],
["require", "dojo.date"],
["require", "dojo.date.stamp"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.AndOrReadStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
