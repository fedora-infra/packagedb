...
return {depends: [["provide", "dojox.data.tests.stores.AndOrWriteStore"],
["require", "dojox.data.AndOrWriteStore"],
["require", "dojo.data.api.Read"],
["require", "dojo.data.api.Identity"],
["require", "dojo.date"],
["require", "dojo.date.stamp"],
["require", "dojo.data.api.Write"],
["require", "dojo.data.api.Notification"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.data.tests.stores.AndOrWriteStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
