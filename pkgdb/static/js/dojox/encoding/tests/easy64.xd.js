...
return {depends: [["provide", "dojox.encoding.tests.easy64"],
["require", "dojox.encoding.easy64"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.tests.easy64"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
