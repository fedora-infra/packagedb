...
return {depends: [["provide", "dojox.collections.tests._base"],
["require", "dojox.collections"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.collections.tests._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
